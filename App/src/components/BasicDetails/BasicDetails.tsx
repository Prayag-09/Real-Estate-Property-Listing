...
const BasicDetails = ({ prevStep, nextStep, propertyDetails, setPropertyDetails }) => {
  ...
  const {title, description, price} = formimport React from "react";
  import { TextInput, Box, Textarea, Group, Button, NumberInput } from "@mantine/core";
  import { useForm } from "@mantine/form";
  import { validateString } from "../../utils/common";
  ...
  const BasicDetails: React.FC<BasicDetailsProps> = ({ prevStep, nextStep, propertyDetails, setPropertyDetails }) => {
    const form = useForm({
      initialValues: {
        title: propertyDetails.title,
        description: propertyDetails.description,
